...
- July 23, 2025: Set default owner star rating to 5.0 stars - updated user schema default rating from 0 to 5.0, applied database schema changes, new users now start with 5-star rating
