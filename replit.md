...
- June 28, 2025: Optimized AI pricing system for lower price targets - switched back to gemini-2.5-flash model and updated prompt to suggest $8-20 range for most items with category-specific examples to maximize booking frequency while maintaining profitability
