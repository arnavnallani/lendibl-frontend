...
- July 18, 2025: Enhanced AI search performance to 2-second maximum response time - reduced AI timeout to 1.5 seconds, eliminated slow alternative suggestions processing, lowered score threshold for faster matching, reduced debounce delay to 300ms, and optimized AI parameters for faster response while maintaining search quality
