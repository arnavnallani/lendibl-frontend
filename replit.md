...
- July 13, 2025: Implemented price-aware AI search functionality - users can now search for "cheap", "low cost", "budget" to get affordable items sorted cheapest first, or "expensive", "premium", "luxury" to get high-end items sorted most expensive first, with direct price filtering, enhanced scoring system, and smart semantic detection of cost-related queries
