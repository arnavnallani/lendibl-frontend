...
- July 13, 2025: Fixed AI banner mobile visibility - adjusted positioning to top-20 on mobile vs top-24 on larger screens, improved responsive sizing with smaller text and icons for mobile, and increased z-index to ensure proper display above all elements on mobile devices
