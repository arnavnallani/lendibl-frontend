...
- June 20, 2025: Fixed item filtering to prevent users from seeing their own listings on home page - items now only appear to other users while remaining visible in owner's profile
