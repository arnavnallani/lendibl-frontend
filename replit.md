...
- July 8, 2025: Added login requirement notification - when non-logged-in users click "Open Reservation Page", they now see a clear toast message: "You must be logged in to reserve items"
