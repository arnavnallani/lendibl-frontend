...
- July 14, 2025: Implemented phone-to-name verification using TeleSign Contact Match API - verifies phone numbers actually belong to registered names to prevent identity fraud, gracefully handles enterprise account limitations by allowing registration while logging verification attempts
