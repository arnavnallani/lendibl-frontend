...
$50 real price items -> $5
$100 real price items -> $8
$200 real price items -> $10
$300 real price items -> $12
$400 real price items -> $14
$500 real price items -> $16
$600 real price items -> $19
$700 real price items -> $22
$800 real price items -> $24
$900 real price items -> $26

Real Price of Item: $${currentPrice}

Make the "why this pricing" section slightly more detailed with market analysis.
    ...
    messages: [
      {
        role: "system",
        content:
          "You are a rental pricing expert. Always respond with valid JSON only.",
      },
      {
        role: "user",
    ...
    try {
      ...
      if (chatGPTResult.success && chatGPTResult.suggestedPrice) {
        ...
        const reasoning = [
          ...
          input.currentPrice
            ? `Based on provided real price: $${originalPrice}`
            : "AI estimated item value",
        ];
        ...
        return {
          ...
          marketInsights: {
            ...
            competitivePosition:
              chatGPTResult.competitivePosition || "market-rate",
          },
        };
      }
      ...
      throw new Error(
        "AI pricing service is currently unavailable. Please try again in a moment.",
      );
    }
  }
