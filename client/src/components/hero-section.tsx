...
export default function HeroSection({ onCategorySelect }: HeroSectionProps) {
  ...
  return (
    <>
      ...
      <section className="bg-white text-gray-dark py-20 relative">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-5xl md:text-7xl font-bold mb-8 animate-slide-up">
            Rent Anything<br />
            <span className="text-gradient bg-gradient-to-r from-primary-blue to-blue-600">From Anyone</span>
          </h2>
