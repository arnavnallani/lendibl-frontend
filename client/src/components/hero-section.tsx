  ...
  return (
    <section className="gradient-bg text-white py-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <p className="text-xl md:text-2xl mb-12 opacity-90 animate-fade-in max-w-3xl mx-auto" style={{animationDelay: '0.3s'}}>It's that simple.Time to make it happen.</p>
