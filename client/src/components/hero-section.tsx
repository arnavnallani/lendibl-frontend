...
export default function HeroSection({ onCategorySelect }: HeroSectionProps) {
  ...
  return (
    <section className="relative text-white py-[5rem] overflow-hidden">
      ...
      {/* Blue-tinged Gradient Overlay for better text readability */}
      <div className="absolute inset-0 bg-gradient-to-r from-blue-900/80 via-sky-800/70 to-cyan-800/75"></div>
