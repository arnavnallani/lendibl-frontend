        ...
        <div className="text-center mt-16">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 max-w-4xl mx-auto">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">
              Join the lendibl Community
            </h2>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
              Whether you're looking to save money on items you rarely use, earn extra income from things you already own, 
              or make a positive impact on the environment, lendibl makes it simple and secure. Join thousands of users 
              who are already sharing, saving, and earning in their communities.
            </p>
          </div>
        </div>
      </div>
