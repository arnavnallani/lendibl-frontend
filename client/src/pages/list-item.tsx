...
export default function ListItem() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-blue-50/15 to-cyan-50/25 relative overflow-hidden">
      {/* Animated Background Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 -left-20 w-96 h-96 bg-gradient-to-r from-sky-400/10 to-blue-500/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute top-3/4 -right-20 w-80 h-80 bg-gradient-to-r from-blue-500/10 to-cyan-600/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-sky-400/5 to-cyan-400/5 rounded-full blur-3xl animate-pulse delay-500"></div>
      </div>
      {/* Navigation Header */}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <Link href="/" className="group flex items-center gap-3 hover:scale-105 transition-all duration-300">
              <div className="p-2 bg-gradient-to-r from-sky-500 to-blue-600 rounded-xl shadow-lg group-hover:shadow-xl transition-all duration-300">
                <ArrowLeft className="h-4 w-4 text-white" />
              </div>
              <span className="font-semibold text-sky-800 group-hover:text-sky-500 transition-colors duration-300">Back to Home</span>
            </Link>
            <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-sky-500 to-blue-600 rounded-full shadow-lg">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-sky-100 to-cyan-200 rounded-full mb-6">
            ...
            <span className="text-sky-700 font-medium text-sm">Turn Your Items Into Income</span>
          </div>
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">Make money off your items... and then get them back in no time</p>
        </div>

        {/* Form Container */}
        <div className="bg-white/60 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
          <div className="bg-gradient-to-r from-sky-600 via-blue-700 to-cyan-600 p-1">
            <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8">
              <Form {...form}>
                ...
                <div className="space-y-4 w-full">
                  ...
                  <div className="flex items-start space-x-2 mt-2 p-3 bg-sky-50 border border-sky-200 rounded-lg">
                    ...
                    <div className="text-sm text-sky-700">
                      ...
                      <p className="text-sky-600">Your address will only be shared with renters after you approve their booking request. It remains private until then.</p>
                    </div>
                  </div>
                </div>
                </div>
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="w-full">
                      ...
                      <div className="group relative">
                        ...
                        <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-sky-200 transition-all duration-300 h-full">
                          <div className="flex items-center gap-3 mb-4">
                            <div className="p-2 bg-gradient-to-r from-sky-500 to-blue-600 rounded-xl">
                          ...
                          <p className="text-gray-600 mb-6">Get intelligent pricing suggestions based on market data, demand patterns, and seasonal trends that work around our algorithms (but you make your own decision ultimately).</p>
                          ...
                          <Button 
                            ...
                            className="w-full bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 text-white rounded-xl py-3 font-medium shadow-lg hover:shadow-xl transition-all duration-300"
