  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/40 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 -left-20 w-96 h-96 bg-gradient-to-r from-blue-500/10 to-blue-600/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute top-3/4 -right-20 w-80 h-80 bg-gradient-to-r from-blue-600/10 to-blue-700/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-blue-400/5 to-blue-500/5 rounded-full blur-3xl animate-pulse delay-500"></div>
      </div>
      {/* Navigation Header */}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <Link href="/" className="group flex items-center gap-3 hover:scale-105 transition-all duration-300">
              <div className="p-2 bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl shadow-lg group-hover:shadow-xl transition-all duration-300">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-100 to-blue-200 rounded-full mb-6">
            <Sparkles className="h-4 w-4 text-blue-700" />
            <span className="text-blue-800 font-medium text-sm">Turn Your Items Into Income</span>
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-gray-900 via-blue-800 to-blue-900 bg-clip-text text-transparent mb-4 leading-tight">
            List Your Item
          </h1>
              ...
              <Form {...form}>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-2 mt-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    <div className="w-4 h-4 bg-blue-600 rounded-full flex-shrink-0 mt-0.5 flex items-center justify-center">
                      <div className="w-1.5 h-1.5 bg-white rounded-full"></div>
                    </div>
                    <div className="text-sm text-blue-800">
                      <p className="font-medium">Privacy Protected</p>
                      <p className="text-blue-700">Your address will only be shared with renters after you approve their booking request. It remains private until then.</p>
                    </div>
                  </div>
                </div>
                </div>
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div className="group relative">
                        ...
                        <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-blue-300 transition-all duration-300 h-full">
                          <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-blue-700 font-medium">Recommended</p>
                            </div>
                          </div>
